...
description: "为项目生成设计系统规则并保存到 CLAUDE.md，指导 Claude Code 按照团队组件规范实现 Figma 设计。适用于为 Claude Code 建立项目级 Figma 设计规范。触发词：设计系统规则、CLAUDE.md规则、Figma规范、设计转代码、设计规范生成。"
---
